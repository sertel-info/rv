...
class CriarNotificacaoCreditosRemovidos
{
 
    public function handle(CreditosRemovidos $event)
    {


        $notifications = Notificacoes::where('escutar_evento', 'CreditosRemovidos')->get();
