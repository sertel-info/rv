...
class NotificacoesUpdateValidator extends FormRequest
{
    /**
    ...
    {   
        $notificacao = \App\Models\Notificacoes\Notificacoes::whereRaw("md5(id) = '".$this->n."'")->first();
        return [
            'nome'=>'required|string|min:3|max:40|unique:filas,nome,'.$notificacao->id,
