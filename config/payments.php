...
return array(
		 ...
		 "notification_url"=> "http://".config('app.url')."/pagamentos/notification/check",
    		 ...
    		 "back_urls"=> array("success"=> "http://".config('app.url')."/pagamentos/finish?status=success",
    							 "pending"=> "http://".config('app.url')."/pagamentos/finish?status=pending",
    							 "failure"=> "http://".config('app.url')."/pagamentos/finish?status=failure"),
