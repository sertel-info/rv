...
<div class='row form-horizontal'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-5'>
                   {{Form::select("tipo", array('random'=>'Randômico', 'ringall'=>'Ringall', 'linear'=>'Linear'),
                   						  null,
                   						  ['class'=>'form-control'])}}
                </div>
            ...
            <div class='form-group'>
                <label class='control-label col-md-3'> Regra de transbordo: </label>
                
                <div class='col-md-5'>
            	  {{Form::select('regra_transbordo', array(0 => 'Desativado',
                                    										 1 => 'Ativado'),null,
              										               ['class'=>'form-control'])}}
                </div>
            </div>
  ...
  <script type="text/javascript">
    ...
    $(function(){
      var linhasPickList = $("#linhas-picklist");
        ...
        $("#form-filas").on("submit", function(ev){
          $(".pickListResult option").prop("selected", true);
        });


        /* temporário: pequena validação do nome */
        $("input[name=nome]").on("input", function(ev){
         
          var value = $(this).val();
          $(this).val( value.replace(/[^a-zA-Z0-9s]+/g, '') );
