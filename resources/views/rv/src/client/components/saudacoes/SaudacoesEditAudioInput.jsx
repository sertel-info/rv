...
class SaudacoesEditAudioInput extends React.Component {
	...
	render(){
		if(this.state.is_editing){
			return (
				<div className="form-group">
					...
					<input type="file" onChange={this.props.onInputChange} name={this.props.name}/>
		...
		return <div className="form-group">
					<label>Áudio</label>
					<AudioPlayer src={_ROUTES_.saudacoes.get_audio.concat("?s=",this.props.saudacao_id)} className="col-lg-12"/>
...
module.exports = SaudacoesEditAudioInput;